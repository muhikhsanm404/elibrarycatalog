		...
		<div class="col-9">
			...
			?>
				...
				<form action="" method="post">
					...
					<div class="form-group mb-2">
						<label>Peran Admin:</label>
						<input type="checkbox" name="is_admin" id="is_admin" value="1" <?php if ($row['is_admin'] == 1) {
																							echo 'checked';
																						} ?>>
					</div>
					<input type="submit" name="update" class="btn btn-success" value="Update User">
